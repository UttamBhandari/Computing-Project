...
<th bgcolor='#797979' style='width: 20%; max-width: 20%'>Edit/Delete</th>
</tr>";
$sn=0;
...
<th bgcolor='#61c66b' style='width: 10%; height:35px'>
<input id='edit_task_date' name='edit_task_date' value='".($row['task_date'])." | ".($row['task_time'])." | ".$current_day."' type='text' style='text-align:center; width:100%; height:100%; border:0' disabled='disabled'/>
</th>
<th bgcolor='#61c66b' style='width: 10%; height:35px'>
...
<th bgcolor='#61c66b' style='width: 10%; height:35px'>
<a href='usermaindashboard.php?pg=editbook&bedit=".($row['task_id'])."'style='color:#0a0; text-decoration: none;' >Edit</a>
</th>
</tr>";
				}else{
					echo "<tr>
...
<th bgcolor='#c66461' style='width: 10%; height:35px'>
<input id='edit_task_date' name='edit_task_date' value='".($row['task_date'])." | ".($row['task_time'])." | ".$current_day."' type='text' style='text-align:center; width:100%; height:100%; border:0;background-color:#c66461' disabled='disabled'/>
</th>
<th bgcolor='#c66461' style='width: 10%; height:35px'>
...
<th bgcolor='#c66461' style='width: 10%; height:35px'>
<a style='color:#555; text-decoration: none;' >Task Done</a>
</th>
</tr>";
