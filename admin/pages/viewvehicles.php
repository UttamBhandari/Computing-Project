...
include("../connection.php");
	...
	{
			echo "<tr style='height:40px'><th bgcolor='#797979' style='width: 10%'>SN</th><th bgcolor='#797979' style='width: 10%'>Vehicle ID</th><th bgcolor='#797979'>Vehicle Name</th><th bgcolor='#797979'>Vehicle Model</th><th bgcolor='#797979'>Vehicle Description</th><th bgcolor='#797979'>Edit/Delete</th></tr>";
		$sn=0;
		...
		if (isset($_GET['pedit']))
		{
			if(($_GET['pedit'])==($row['vehicle_id']))
			{
				...
				<th bgcolor='#dfdfdf' style='width: 10% '><a href='javascript:%20update_vehicle()'  style='color:#0a0; text-decoration: none;' >Done</a></th>	
				</tr>
				<tr>
				...
				<th bgcolor='#dfdfdf' style='width: 10%;'>Edit</th>
				</tr>
				<tr>
				<th bgcolor='#dfdfdf' style='width: 10%'>Delete</th>
				</tr>");
			}
		}else{
				echo ("<tr>
				...
				<th rowspan='2' bgcolor='#dfdfdf'>"."<input id='vehicle_model' name='vehicle_model' value='".($row['vehicle_model'])."' type='text' style='text-align:center; width:100%; height:100%; border:0;' disabled='disabled'/>"."</th>
				<th rowspan='2' bgcolor='#dfdfdf'>"."<input id='vehicle_description' name='vehicle_description' value='".($row['vehicle_description'])."' type='text' style='text-align:center; width:100%; height:100%; border:0;' disabled='disabled'/>"."</th>
				<th bgcolor='#dfdfdf' style='width: 10% '><a href='index.php?pg=viewvehicles&pedit=".($row['vehicle_id'])."'style='color:#0a0; text-decoration: none; ' >Edit</a></th>
				</tr>
				<tr>
				<th bgcolor='#dfdfdf' style='width: 10%'><a href='index.php?pg=viewvehicles&pdel=".($row['vehicle_id'])."'style='color:#a00; text-decoration: none;' >Delete</a></th>
				</tr>");
		}
...
<script>
    function update_vehicle() {
        ...
        var link = "actions/editvehicle.php?";
        if (document.getElementById('edit_vehicle_name').value != "" )
        {
            //alert("Fill All Fields !");
            var link = (link + "&epn=" + (document.getElementById('edit_vehicle_name').value));
        }
        if (document.getElementById('edit_vehicle_model').value != "" )
        {
            //alert("Fill All Fields !");
            var link = (link + "&ept=" + (document.getElementById('edit_vehicle_model').value));
        }
        if (document.getElementById('edit_vehicle_description').value != "" )
        {
            //alert("Fill All Fields !");
            var link = (link + "&epb=" + (document.getElementById('edit_vehicle_description').value));
        }
        if (document.getElementById('edit_vehicle_id').value != "" )
        {
            //alert("Fill All Fields !");
            var link = (link + "&epid=" + (document.getElementById('edit_vehicle_id').value));
        }
//alert((document.getElementById('edit_vehicle_id').value));
